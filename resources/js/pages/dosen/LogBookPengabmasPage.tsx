...
import LogbookPengabmas from '@/components/LogbookPengabmas';
        ...
        <DashLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="rounded-lg bg-white p-6 shadow">
                ...
                <div className="rounded-b border bg-white p-4">
                    {activeTab === 'input' && <InputLogbook title="Pengabmas"></InputLogbook>}
                    {activeTab === 'logbook' && <LogbookPengabmas></LogbookPengabmas>}
                </div>
            </div>
        </DashLayout>
    );
