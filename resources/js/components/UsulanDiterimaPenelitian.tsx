...
type DataRowUsulanDiterimaPenelitian = {
    id: number;
    nik: string;
    namaPengusul: string;
    fakultas: string;
...
export default function UsulanDiterimaPenelitian() {
    const data: DataRowUsulanDiterimaPenelitian[] = [
        {
            id: 1,
            nik: '19870315001',
    ...
    const columns: TableColumn<DataRowUsulanDiterimaPenelitian>[] = [
        {
            name: 'No',
    ...
    return (
        <div className="rounded-lg bg-white p-6 shadow">
            <h2 className="mb-2 text-xl font-semibold">Data Usulan Diterima</h2>
