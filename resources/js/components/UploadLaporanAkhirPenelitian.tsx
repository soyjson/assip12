...
export default function UploadLaporanAkhirPenelitian() {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 rounded-lg bg-white p-6 shadow">
            ...
            <div>
                <label className="mb-1 block text-sm font-medium">
                    Lama Penelitian<span className="text-red-500">*</span>
                </label>
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="w-fit cursor-pointer bg-amber-400 px-2 py-1">+ Lainnya</span>
            </div>
