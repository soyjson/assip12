...
type DataRowUsulanDiterimaPengabmas = {
    id: number;
    nik: string;
    namaPengusul: string;
    fakultas: string;
...
export default function UsulanDiterimaPengabmas() {
    const data: DataRowUsulanDiterimaPengabmas[] = [
        {
            id: 1,
            nik: '19870315001',
    ...
    const columns: TableColumn<DataRowUsulanDiterimaPengabmas>[] = [
        {
            name: 'No',
