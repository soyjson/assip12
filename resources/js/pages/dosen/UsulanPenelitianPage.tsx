import DataPenelitian from '@/components/DataPenelitian';
import TabUsulanPenelitian from '@/components/TabUsulanPenelitian';
...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: '/dosen/usulan-penelitian',
    },
];

export default function UsulanPenelitian() {
    const [activeTab, setActiveTab] = useState('usulan');

    const tabs = [
        { id: 'usulan', label: 'Usulan Penelitian' },
        { id: 'data', label: 'Data Usulan Penelitian' },
        { id: 'download', label: 'Download Format Usulan' },
    ];

    return (
        <DashLayout breadcrumbs={breadcrumbs}>
            <Head title="ASIPP | Usulan Penelitian" />
            <div className="rounded-lg bg-white p-6 shadow">
                ...
                <div className="rounded-b border bg-white px-4 py-0">
                    {activeTab === 'usulan' && <TabUsulanPenelitian></TabUsulanPenelitian>}
                    {activeTab === 'data' && <DataPenelitian></DataPenelitian>}
                    {activeTab === 'download' && (
