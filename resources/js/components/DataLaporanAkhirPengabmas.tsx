export default function DataLaporanAkhirPengabmas() {
    const data = [
        {
            id: 1,
    ...
    return (
        <div className="rounded-lg bg-white p-6 shadow">
            <h2 className="mb-2 text-xl font-semibold">Data Laporan Akhir Pengabdian Masyarakat</h2>
                ...
                <table className="w-full border border-gray-200 text-sm">
                    <thead className="bg-gray-100 text-left">
                        <tr>
                            ...
                            <th className="border px-3 py-2">Lama Pengabmas</th>
