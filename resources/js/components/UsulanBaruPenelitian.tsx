...
type DataRowUsulanBaruPenelitian = {
    id: number;
    nik: string;
    namaPengusul: string;
    fakultas: string;
...
export default function UsulanBaruPenelitian() {
    const data: DataRowUsulanBaruPenelitian[] = [
        {
            id: 1,
            nik: '19870315001',
    ...
    const columns: TableColumn<DataRowUsulanBaruPenelitian>[] = [
        {
            name: 'No',
        ...
        },
        {
            ...
            // cell: (row) => <Badge className=''>{row.status}</Badge>,
            sortable: true,
            wrap: true,
            center: true,
        },
