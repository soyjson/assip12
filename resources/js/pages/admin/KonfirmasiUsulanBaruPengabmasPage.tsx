import UsulanBaruPengabmas from '@/components/UsulanBaruPengabmas';
import UsulanDiterimaPengabmas from '@/components/UsulanDiterimaPengabmas';
import UsulanDitolakPengabmas from '@/components/UsulanDitolakPengabmas';
...
export default function KonfirmasiUsulanBaruPengabmasPage() {
        ...
        <DashLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="rounded-lg bg-white p-6 shadow">
                ...
                <div className="rounded-b border bg-white px-4 py-0">
                    {activeTab === 'baru' && <UsulanBaruPengabmas></UsulanBaruPengabmas>}
                    {activeTab === 'terima' && <UsulanDiterimaPengabmas></UsulanDiterimaPengabmas>}
                    {activeTab === 'tolak' && <UsulanDitolakPengabmas></UsulanDitolakPengabmas>}
                </div>
            </div>
        </DashLayout>
    );
