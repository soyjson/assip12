import DataReviewLaporanAkhirPenelitian from '@/components/DataReviewLaporanAkhirPenelitian';
import DataReviewLaporanAkhirPengabmas from '@/components/DataReviewLaporanAkhirPengabmas';
...
export default function ReviewLaporanAkhir() {
        ...
        <DashLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="rounded-lg bg-white p-6 shadow">
                ...
                <div className="rounded-b border bg-white px-4 py-0">
                    {activeTab === 'penelitian' && <DataReviewLaporanAkhirPenelitian></DataReviewLaporanAkhirPenelitian>}
                    {activeTab === 'pengabmas' && <DataReviewLaporanAkhirPengabmas></DataReviewLaporanAkhirPengabmas>}
                </div>
            </div>
        </DashLayout>
    );
