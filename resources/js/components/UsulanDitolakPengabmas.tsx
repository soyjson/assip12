...
type DataRowUsulanDitolakPengabmas = {
    id: number;
    nik: string;
    namaPengusul: string;
    fakultas: string;
...
export default function UsulanDitolakPengabmas() {
    const data: DataRowUsulanDitolakPengabmas[] = [
        {
            id: 1,
            nik: '19870315001',
    ...
    const columns: TableColumn<DataRowUsulanDitolakPengabmas>[] = [
        {
            name: 'No',
