...
type DataRowHasilReviewPengabmas = {
    id: number;
    namaPengusul: string;
...
export default function HasilReviewPengabmas() {
    const data: DataRowHasilReviewPengabmas[] = [
        {
            id: 1,
        ...
        },
        {
            ...
            judulPengabmas: 'Kajian Dampak Pembangunan Jalan Tol Terhadap Ekonomi Lokal',
        ...
        },
        {
            ...
            tanggapan: 'Proses paten berjalan lancar. Hasil Pengabmas berdampak luas. Selesai.',
            nilai: 'A+',
            jenisLaporan: 'Laporan Akhir',
    ...
    const columns: TableColumn<DataRowHasilReviewPengabmas>[] = [
        {
            name: 'No',
    ...
    return (
        <div className="rounded-lg bg-white p-6 shadow">
            <h2 className="mb-2 text-xl font-semibold">Daftar Review Pengabmas</h2>
