...
import AturPlotingUsulanForm from './AturPlotingUsulanForm';
...
const dataReviewer: DataRow[] = [
    {
        ...
        judulPengabmas: 'Pengembangan Sistem Informasi Geospasial Bencana Alam',
    ...
    },
    {
        ...
        judulPengabmas: 'Analisis Kualitas Air Minum Perkotaan Menggunakan Sensor IoT',
    ...
    },
    {
        ...
        judulPengabmas: 'Efektivitas Model Pembelajaran Berbasis Proyek (PBL) pada SMK',
    ...
    },
    {
        ...
        judulPengabmas: 'Perancangan Sistem Pakar Diagnosa Penyakit Tropis dengan Metode Fuzzy',
    ...
    },
    {
        ...
        judulPengabmas: 'Kajian Dampak Pembangunan Infrastruktur Jalan Tol Terhadap Ekonomi Lokal',
    ...
    },
    {
        ...
        judulPengabmas: 'Sintesis Nanomaterial Karbon untuk Aplikasi Baterai Lithium-Ion',
    ...
    },
    {
        ...
        judulPengabmas: 'Penerapan Data Mining untuk Prediksi Tingkat Kepuasan Pelanggan',
    ...
    },
    {
        ...
        judulPengabmas: 'Optimalisasi Desain Turbin Air Pico Hydro Skala Rumah Tangga',
    ...
    },
    {
        ...
        judulPengabmas: 'Studi Komparatif Implementasi Merdeka Belajar di Perguruan Tinggi Swasta',
    ...
    },
    {
        ...
        judulPengabmas: 'Analisis Faktor yang Mempengaruhi Adopsi Fintech pada Generasi Milenial',
    ...
    },
    {
        ...
        judulPengabmas: 'Pengembangan Aplikasi Mobile untuk Layanan Kesehatan Primer',
    ...
    },
    {
        ...
        judulPengabmas: 'Peningkatan Efisiensi Pembangkit Listrik Tenaga Surya Hibrid',
        reviewer1: 'Ir. Citra Dewi, M.T.',
        reviewer2: 'Iwan Darmawan, S.T., M.T.',
    ...
    },
    {
        ...
        judulPengabmas: 'Integrasi Nilai Pancasila dalam Pengembangan Kurikulum Digital',
        reviewer1: 'Andi Pratama, S.Pd., M.A.',
    ...
    },
    {
        ...
        judulPengabmas: 'Implementasi Internet of Things (IoT) untuk Sistem Irigasi Cerdas',
    ...
    },
    {
        ...
        judulPengabmas: 'Analisis Peran Media Sosial dalam Pembentukan Opini Publik Lokal',
    ...
    },
    {
        ...
        judulPengabmas: 'Pengembangan Alat Ukur Kepuasan Kerja Dosen Berbasis Budaya Organisasi',
    ...
    },
    {
        ...
        judulPengabmas: 'Kajian Hukum Pidana terkait Kejahatan Siber di Indonesia',
    ...
    },
    {
        ...
        judulPengabmas: 'Inovasi Pakan Ternak Berbasis Fermentasi Limbah Pertanian',
    ...
    },
    {
        ...
        judulPengabmas: 'Pengaruh Senam Aerobik terhadap Kualitas Tidur Lansia di Panti Jompo',
    ...
    },
    {
        ...
        judulPengabmas: 'Pengembangan Purwarupa Sistem Peringatan Dini Kebakaran Hutan',
        reviewer1: 'Ir. Citra Dewi, M.T.',
    ...
    },
    {
        ...
        judulPengabmas: 'Penerapan Metode Gamifikasi dalam Peningkatan Hasil Belajar Geografi',
    ...
    },
    {
        ...
        judulPengabmas: 'Klasifikasi Citra Satelit Resolusi Tinggi Menggunakan Deep Learning',
    ...
    },
    {
        ...
        judulPengabmas: 'Studi Kelayakan Investasi Proyek Infrastruktur Berkelanjutan',
    ...
    },
    {
        ...
        judulPengabmas: 'Analisis Kebijakan Pengelolaan Sampah Zero Waste di Tingkat Desa',
        reviewer1: 'Oscar Darmawan, S.I.P., M.A.',
    ...
    },
    {
        ...
        judulPengabmas: 'Kajian Filologi Naskah Kuno Sastra Melayu dan Nilai Budaya Lokal',
    ...
    },
    {
        ...
        judulPengabmas: 'Perancangan Sistem Pengendali Kendaraan Otonom Skala Mini',
    ...
    },
    {
        ...
        judulPengabmas: 'Uji Toksisitas dan Aktivitas Anti-Kanker Ekstrak Tanaman Herbal X',
    ...
    },
    {
        ...
        judulPengabmas: 'Pemodelan Spasial Distribusi Sumber Daya Air Permukaan',
    ...
    },
    {
        ...
        judulPengabmas: 'Peran Lembaga Keagamaan dalam Peningkatan Kesejahteraan Sosial',
    ...
    },
    {
        ...
        judulPengabmas: 'Eksplorasi Teknik Visualisasi Data dalam Seni Rupa Kontemporer',
        reviewer1: 'Prof. Vino Adrianto, M.Sn.',
...
export default function PlotingReviewerUsulanPengabmas() {
    ...
    //     error?: string;
    //     name: keyof typeof open;
    //   }) => (
    //     <div className="flex flex-col space-y-1">
    //       <Label className="font-semibold">{label}</Label>
    //       <Popover open={open[name]} onOpenChange={(v) => setOpen({ ...open, [name]: v })}>
    ...
    return (
        <div className="space-y-6 p-4">
            <AturPlotingUsulanForm title="Pengabmas" />
